...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/30 transition-all duration-300 data-open:opacity-100 data-closed:opacity-0",
        className,
      )}
      {...props}
    />
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "data-closed:opacity-0 data-closed:translate-y-[-100%]",
